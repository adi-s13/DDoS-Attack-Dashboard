...
if uploaded_file is not None:
    ...
    st.write("DEBUG - numeric predictions:", predictions_numeric[:10])
    st.write("DEBUG - decoded predictions:", pred_labels[:10])
    st.write("DEBUG - label encoder classes:", preprocessor['label_encoder'].classes_)
    ...
    st.info("⬆️ Upload a CSV file with all required features (see documentation or use the dummy generator).")
